...
import { typeWriterEffect } from '../utils/other.js';
...
export const apps = [
  ...
  },
  {
    ...
    functions: (win) => {
      ...
      win.querySelector('.ifContent').addEventListener('wheel', activateIframe);
      win.querySelector('.ifContent').addEventListener('click', activateIframe);
    }
  }
];
